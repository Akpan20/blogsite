...
class SubscriptionService
{
    ...
    public function getSubscriptionAnalytics(): array
    {
        ...
        // FIXED: Use a full aggregation pipeline with $match
        $subscriptionsByPlan = UserSubscription::raw(function ($collection) {
            ...
            $plan = SubscriptionPlan::find($group['_id']);
            return [
                'subscription_plan_id' => $group['_id'],
                'count' => $group['count'],
