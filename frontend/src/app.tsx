...
const DebugNotifications = lazy(() => import('@/pages/DebugNotifications'));
    ...
    children: [
      ...
      // Public blog routes (wrapped in BlogLayout)
      {
        ...
        children: [
          ...
          { path: '/debug-notifs', element: <DebugNotifications /> }
        ],
      },
      ...
      // ═══════════════════════════════════════
      {
        ...
        children: [
          ...
          // Protected routes (BlogLayout)
          {
            element: <PublicRoute />,
            children: [
              { path: '/messages/:username?', element: <MessagingInterface /> },
