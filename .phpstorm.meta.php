...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links./home/akan/blogsite/public/storage' => 'string',
            ...
            'services.paystack.public_key' => 'string',
            'services.paystack.secret_key' => 'string',
            'services.paystack.payment_url' => 'string',
            ...
            'cashier-paystack.public_key' => 'string',
            'cashier-paystack.secret_key' => 'string',
            'cashier-paystack.path' => 'string',
            'cashier-paystack.merchant_email' => 'NULL',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links./home/akan/blogsite/public/storage','logging.default',
...
'reverb.apps.apps.0.ping_interval','reverb.apps.apps.0.activity_timeout','reverb.apps.apps.0.max_connections','reverb.apps.apps.0.max_message_size','sanctum.stateful',
...
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.paystack.public_key','services.paystack.secret_key',
'services.paystack.payment_url','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'session.same_site','session.partitioned','cashier-paystack.public_key','cashier-paystack.secret_key','cashier-paystack.path',
'cashier-paystack.merchant_email','ide-helper.filename','ide-helper.models_filename','ide-helper.meta_filename','ide-helper.include_fluent',
...
'sanctum.csrf-cookie','paystack.webhook','login',
'posts.index','posts.show','posts.store',
'posts.destroy',
'comments.destroy','posts.update','comments.index',
'comments.store','storage.local',);
        registerArgumentsSet('views', 
'app','components.timeline-item','welcome','cashier::receipts','laravel-exceptions-renderer::components.badge',
...
'SESSION_SECURE','SESSION_HTTP_ONLY','SESSION_SAME_SITE','SANCTUM_STATEFUL_DOMAINS','SANCTUM_GUARD',
'APP_URL','FRONTEND_URL','CORS_ALLOWED_ORIGINS','CORS_SUPPORTS_CREDENTIALS','BROADCAST_CONNECTION',
...
'AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','SANCTUM_STATEFUL_DOMAINS','SESSION_DOMAIN','REVERB_APP_ID',
'REVERB_APP_KEY','REVERB_APP_SECRET','REVERB_HOST','REVERB_PORT','REVERB_SCHEME',
'VITE_REVERB_APP_KEY','VITE_REVERB_HOST','VITE_REVERB_PORT','VITE_REVERB_SCHEME','BROADCAST_CONNECTION',
