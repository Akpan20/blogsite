      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center h-16">
          ...
          <div className="hidden md:flex items-center gap-6">
            ...
            <Link to="/categories" className="text-gray-700 hover:text-blue-600 font-medium transition">
              Categories
            </Link>
            <Link to="/series" className="text-gray-700 hover:text-blue-600 font-medium transition">
              Series
            </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link to="/education" className="hover:text-white transition">Creator Education</Link>
              </li>
              <li>
                <Link to="/support" className="hover:text-white transition">Support</Link>
              </li>
              <li>
                <Link to="/guidelines" className="hover:text-white transition">Community Guidelines</Link>
              </li>
              <li>
                <Link to="/api-docs" className="hover:text-white transition">API Documentation</Link>
              </li>
            </ul>
          </div>
